...
4. Next, replace the values in the `configs/` yaml files, as to your parameters. You can now run `scripts/run_all_sessions.py` to process all of the sessions within the Visual Behavior Neuropixels dataset, on your chosen parameters.
